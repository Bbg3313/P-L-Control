...
import { REVENUE_DETAIL_CATEGORIES } from "@/lib/revenue-detail-categories";
...
> = {
  revenue: {
    ...
    detailCategoryLabel: "상세 카테고리",
    secondaryLabel: "카테고리",
    secondaryPlaceholder: "예: 대행 수수료",
    gridClass:
      "grid-cols-1 sm:grid-cols-[minmax(0,1fr)_6.5rem_minmax(0,1fr)_5.5rem_minmax(8rem,1fr)_2.5rem]",
    gridClassWithMonth:
      "grid-cols-1 sm:grid-cols-[7rem_minmax(0,1fr)_6.5rem_minmax(0,1fr)_5.5rem_minmax(9rem,1fr)_2.5rem]",
  },
  expense: {
    primaryLabel: "비용 항목",
    ...
    <div className="min-w-0 space-y-4">
      ...
      <div className="min-w-0 space-y-2">
        ...
        >
          ...
          {kind === "revenue" && (
            <>
              <span>{config.detailCategoryLabel}</span>
            ...
            {kind === "revenue" && (
              <>
                <select
                  ...
                  aria-label="상세 카테고리"
                  value={
                    row.detailCategory || REVENUE_DETAIL_CATEGORIES[0]
                  }
                  onChange={(e) =>
                    updateRow(row.key, { detailCategory: e.target.value })
                  }
                >
